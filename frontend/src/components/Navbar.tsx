...
export function Navbar() {
  return (
    <header className="sticky top-0 z-50 border-b border-cv-border bg-cv-elev backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-2 px-4 py-3 sm:gap-3 sm:py-4">
        ...
        <nav className="ml-auto flex flex-wrap items-center justify-end gap-1 text-xs sm:gap-3 sm:text-sm">
          <Link
            href="/search"
            className="rounded-full px-3 py-2 text-cv-muted hover:bg-cv-border hover:text-cv-text"
          >
            Search
          </Link>
          <NavbarAuth />
